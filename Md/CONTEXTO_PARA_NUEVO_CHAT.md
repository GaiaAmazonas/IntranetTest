...
| Banners de Inicio | Textos, vigencia y acciones desde Dataverse. **Imágenes temporalmente locales** en `apps/web/public/banners/temporary/Img2/3/4*.jpg`, con variantes Mobile. SharePoint todavía no está integrado para sustituirlas. |
